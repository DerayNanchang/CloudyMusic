...
inline fun <reified T : Activity> Fragment.startActivityForResult(
    ...
    activity?.let {
        startActivityForResult(AnkoInternals.createIntent(it, T::class.java, params), requestCode)
    }
}
...
@Deprecated(message = "Use support library fragments instead. Framework fragments were deprecated in API 28.")
inline fun <reified T : Service> Fragment.startService(vararg params: Pair<String, Any?>) = run {
    activity?.let {
        AnkoInternals.internalStartService(it, T::class.java, params)
    }
}
...
inline fun <reified T : Service> Context.stopService(vararg params: Pair<String, Any?>) =
    kotlin.run {
        this?.let {
            AnkoInternals.internalStopService(it, T::class.java, params)
        }
    }
...
@Deprecated(message = "Use support library fragments instead. Framework fragments were deprecated in API 28.")
inline fun <reified T : Service> Fragment.stopService(vararg params: Pair<String, Any?>) = run {
    activity?.let {
        AnkoInternals.internalStopService(it, T::class.java, params)
    }
}
...
@Deprecated(message = "Use support library fragments instead. Framework fragments were deprecated in API 28.")
inline fun <reified T : Any> Fragment.intentFor(vararg params: Pair<String, Any?>): Intent? = run {
    activity?.let {
        AnkoInternals.createIntent(it, T::class.java, params)
    }
}
...
@Deprecated(
    ...
    replaceWith = ReplaceWith("com.lsn.comm.core.exts.newDocument")
)
...
@Deprecated(message = "Use support library fragments instead. Framework fragments were deprecated in API 28.")
inline fun Fragment.browse(url: String, newTask: Boolean = false) = run {
...
@Deprecated(message = "Use support library fragments instead. Framework fragments were deprecated in API 28.")
inline fun Fragment.share(text: String, subject: String = "", title: String? = null) = run {
...
@Deprecated(message = "Use support library fragments instead. Framework fragments were deprecated in API 28.")
inline fun Fragment.email(email: String, subject: String = "", text: String = "") = run {
...
@Deprecated(message = "Use support library fragments instead. Framework fragments were deprecated in API 28.")
inline fun Fragment.makeCall(number: String): Boolean = run {
    if (activity == null) {
        false
    } else {
...
@Deprecated(message = "Use support library fragments instead. Framework fragments were deprecated in API 28.")
inline fun Fragment.sendSMS(number: String, text: String = ""): Boolean = kotlin.run {
    if (activity == null) {
        false
    } else {
