...
inline fun Fragment.dip(value: Int): Int = run {
    if (activity == null) {
        0
    } else {
        activity!!.dip(value)
...
inline fun Fragment.dip(value: Float): Int =
    run {
        if (activity == null) {
            0
        } else {
...
inline fun Fragment.sp(value: Int): Int =
    run {
        if (activity == null) {
            0
        } else {
...
inline fun Fragment.sp(value: Float): Int =
    run {
        if (activity == null) {
            0
        } else {
...
inline fun Fragment.px2dip(px: Int): Float =
    run {
        if (activity == null) {
            0F
        } else {
...
inline fun Fragment.px2sp(px: Int): Float =
    run {
        if (activity == null) {
            0F
        } else {
...
inline fun Fragment.dimen(@DimenRes resource: Int): Int =
    run {
        if (activity == null) {
            0
        } else {
            activity!!.dimen(resource)
        }
    }
