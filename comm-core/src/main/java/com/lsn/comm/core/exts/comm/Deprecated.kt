...
import com.lsn.comm.core.exts.comm.collections.forEachReversedByIndex
import java.lang.ref.WeakReference
import java.util.concurrent.ExecutorService
import java.util.concurrent.Future

@Deprecated("Use forEachReversedByIndex(f) instead.",
        ReplaceWith("forEachReversedByIndex(f)", "com.lsn.comm.core.exts.collections.forEachReversedByIndex"))
